package net.mcreator.alexwonderland.client.model;
...
public class Modelalexphantom<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("alex_wonderland", "modelalexphantom"), "main");
	public final ModelPart body;
	public final ModelPart wing0;
	public final ModelPart wingtip0;
