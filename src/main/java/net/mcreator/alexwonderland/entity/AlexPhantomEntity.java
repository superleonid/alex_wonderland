...
public class AlexPhantomEntity extends Monster {
	public AlexPhantomEntity(EntityType<AlexPhantomEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public static void init(SpawnPlacementRegisterEvent event) {
		event.register(AlexWonderlandModEntities.ALEX_PHANTOM.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
